	...
	<div class='row'>
		<div class="panel panel-primary mainbody">
		  <div class="panel-heading">
			<h3 class="panel-title">Inactive Measurements</h3>
		  </div>
		  ...
		  <?php include("stock_nav.php"); ?>
			...
			<div class='well'>
				...
				<table class='table table-condensed' id='datatables'>
					...
					<tbody>
						<?php 
							$sql = "SELECT * FROM quantity WHERE status='0' ORDER BY id DESC";
							$get = mysqli_query($db, $sql);
								...
								while( $res = mysqli_fetch_array($get) ){
									...
									$stat = "<a class='btn btn-xs btn-primary activateitem' data-name='measurements' data-id='$id' ><span class='glyphicon glyphicon-eye-close'></span></a>";
