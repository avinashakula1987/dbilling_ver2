					...
					<table class='table table-condensed table-bordered' id='datatables'>
						...
						<tbody>
							...
							<?php 
								...
								$sql = "SELECT finaltotal AS totalpurchases, customer, city, state, date, transaction, openingBalance, id, returnStatus, refId, fullPayment, partialPayment FROM invoices WHERE login='$login' AND date BETWEEN '$date1' AND '$date2' AND status='1' $c";
								$sno = 0;
